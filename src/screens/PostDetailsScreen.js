...
//   const [commentImage, setCommentImage] = useState(null); // base64 format
...
//     try {
//       const res = await fetch(`http://192.168.1.206:5000/api/posts/${postId}/details`);
...
//     try {
//       const res = await fetch(`http://192.168.1.206:5000/api/comments`, {
//         method: 'POST',
...
//           ...prev,
//           {
//             _id: data.comment?._id || Date.now().toString(), // fallback unique key
//             userName: 'You',
//             userImage: null,
//             text: newComment,
//           },
...
//   container: { flex: 1, backgroundColor: '#f2f2f2', paddingBottom: 100,},
